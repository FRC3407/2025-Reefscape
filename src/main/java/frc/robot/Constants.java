...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 14; //FAST GEAR
  ...
  public static final class ElevatorConstants {
    ...
    public static final double coral_low = 0; //stopped here when adding variable for the height of each level
    public static final double algae_low = -5.0;
    public static final double coral_high = -35.0;
    public static final double algae_high = -70.0;
